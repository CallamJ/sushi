...
process() {
    local user="$1"
    __sushi_struct_check "${user:-}" 'name:string:req,age:int:req' 'parameter '"'"'user'"'"' of function '"'"'process'"'"'' || exit 2
    printf '%s\n' "$(__sushi_json_member "${user:-}" 'name')"
    return 0
}
input="$(__sushi_json_object 'name' 'alice' 'age' 42)"
