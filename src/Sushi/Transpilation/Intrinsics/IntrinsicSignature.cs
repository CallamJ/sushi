...
public sealed class IntrinsicSignature
{
    ...
    private static IrTypeRef DefaultReturnType(IntrinsicId id) => id switch
    {
        ...
        IntrinsicId.StringLength or IntrinsicId.FsFileSize or IntrinsicId.FsDirectorySize or
        IntrinsicId.MathFloor or IntrinsicId.MathCeil => IrTypeRef.Primitive("int"),
